...
# Video 6
# read data direct from internet instead of download them manually
...
# es:
esGroups <- cutree(clusterMovies, k = 2)
head(esGroups)

zz <- cbind(movies, esGroups)
colSums(zz[zz$esGroups == 2,2:20])
